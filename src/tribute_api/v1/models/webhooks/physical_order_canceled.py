...
class TributePhysicalOrderCanceledPayload(BaseModel):
...
class TributePhysicalOrderCanceledNotification(TributeBaseNotification):
    """Notification about physical order cancellation."""

    name: Literal[TributeNotificationType.PHYSICAL_ORDER_CANCELED]
    payload: TributePhysicalOrderCanceledPayload
