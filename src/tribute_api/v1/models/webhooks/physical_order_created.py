...
class TributePhysicalOrderCreatedPayload(BaseModel):
...
class TributePhysicalOrderCreatedNotification(TributeBaseNotification):
    """Notification about new physical order creation."""

    name: Literal[TributeNotificationType.PHYSICAL_ORDER_CREATED]
    payload: TributePhysicalOrderCreatedPayload
