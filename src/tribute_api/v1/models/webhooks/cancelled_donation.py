...
class TributeCancelledDonationPayload(BaseModel):
...
class TributeCancelledDonationNotification(TributeBaseNotification):
    """Notification about a cancelled recurring donation."""

    name: Literal[TributeNotificationType.CANCELLED_DONATION]
    payload: TributeCancelledDonationPayload
